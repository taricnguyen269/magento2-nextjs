...
export default (node, props) => {
    const isLCP = node.classList.contains('image-lcp') ?? false;
    ...
    return {
        isLCP,
        imgAlt: overlayElement
            ? overlayElement.getAttribute('aria-label')
            : null,
        ...
        linkTitle: linkElement ? linkElement.getAttribute('title') : null,
        ...
        videoMobileSrc: wrapperElement.getAttribute('data-mobile-video-src'),
        videoMobileFallbackSrc: wrapperElement.getAttribute(
            'data-mobile-video-fallback-src'
        ),
