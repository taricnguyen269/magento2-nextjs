...
import { useDetectScrollWidth } from '../../../adapters/peregrine-hooks';
import { useMediaQuery } from '../../../adapters/peregrine-hooks';
...
const Row = props => {
    ...
    //
    // useDetectScrollWidth is called but not used in this component
    // Keeping it for compatibility but not passing a ref since it's not needed
    useDetectScrollWidth(null);
